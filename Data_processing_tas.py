...
racmo_snowdepth = '/NC_DEFAULT/tas.KNMI-2001.PXARC11.RACMO24_1_complete6_UAR_q_noice_khalo6_era5q.DD.nc'
...
for _ , year in enumerate(years):
    ...
    if calc_stationdata:
        ...
        for i,v in enumerate(stations):
            ...
            station_snow_depth = observation.loc[(observation['station_name'] == v) & (observation['observed_variable'] == 'air_temperature')]
